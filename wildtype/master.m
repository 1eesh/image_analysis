...
%%Loading the data
load('/Users/eesh/Desktop/eesh_summer_14/centerofmass_wildtype/Membranes--vertices--Vertex-x.mat');
datax=data;
cell_number=size(datax,3); % This just assigns 109 to the cel_number for the given file
load('/Users/eesh/Desktop/eesh_summer_14/centerofmass_wildtype/Membranes--vertices--Vertex-y.mat'); %this loads the y 
datay=data;
...
for cell_index=1:cell_number, %this mega for loop calculates the COM for all the cells which are taken from the edge output
   ...
   %myosin distribution 
   run('/Users/eesh/Desktop/eesh_summer_14/centerofmass_wildtype/centerofmass_cell');
...
%%
    ...
    run('/Users/eesh/Desktop/eesh_summer_14/centerofmass_wildtype/radial_distribution.m');
...
k = waitforbuttonpress ;
 ...
 rok=0;%this is just for plotting
  run('/Users/eesh/Desktop/eesh_summer_14/centerofmass_wildtype/plot_radial.m');
...
%%PLOT FOR MYOSIN AVERAGE IVER CELLS 
 ...
 run('/Users/eesh/Desktop/eesh_summer_14/centerofmass_wildtype/averageovercells.m');
